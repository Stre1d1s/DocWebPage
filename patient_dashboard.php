                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold">Welcome <?php echo htmlspecialchars($user['full_name']); ?>!</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <form class="forms-sample">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputName1" value="<?php echo htmlspecialchars($user['full_name']); ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail3">Email address</label>
                                            <input type="email" class="form-control" id="exampleInputEmail3" value="<?php echo htmlspecialchars($user['email']); ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword4">Phone Number</label>
                                            <input type="text" class="form-control" id="exampleInputName1" value="<?php echo htmlspecialchars($user['contact_information']); ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputName1">ID Number</label>
                                            <input type="text" class="form-control" id="exampleInputName1" value="<?php echo htmlspecialchars($user['identity_number']); ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputName1">AMKA</label>
                                            <input type="text" class="form-control" id="exampleInputName1" value="<?php echo htmlspecialchars($user['amka']); ?>" readonly>
                                        </div>
                                    </form>
                                </div>
                            </div>
